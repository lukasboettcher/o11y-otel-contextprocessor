...
require (
	github.com/lukasboettcher/o11y-otel-contextprocessor/contextprocessor v0.116.0
...
replace github.com/lukasboettcher/o11y-otel-contextprocessor/contextprocessor => ./contextprocessor
